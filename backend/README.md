...
## Project Structure
    ...
    ├── junkyard_express_32016  # Django project configurations
...
1. Clone this repo and `cd junkyard_express_32016`
...
2. Clone this repo and `cd junkyard_express_32016`
